                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                                        ...
                                        class=" shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden @error('name') border-red-400 focus:border-red-400 focus:ring-red-500/10 @enderror"" />
                                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                </div>
                                <!-- Email -->
                                <div>
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPasswordConfirmation: false }" class="relative">
                                        <input :type="showPasswordConfirmation ? 'text' : 'password'"
                                            ...
                                            class=" shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden @error('password_confirmation') border-red-400 focus:border-red-400 focus:ring-red-500/10 @enderror"" />
                                        <span @click="showPasswordConfirmation = !showPasswordConfirmation"
                                            class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500">
                                            <svg x-show="!showPasswordConfirmation" class="fill-current" width="20"
