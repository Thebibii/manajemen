                ...
                <li @click="handleItemClick()">
                    <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100"
                        ...
                        <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                            ...
                            <span
                                class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white {{ $notification['status'] === 'online' ? 'bg-success-500' : 'bg-error-500' }}"></span>
                        </span>
