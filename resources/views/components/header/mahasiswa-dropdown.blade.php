<div class="relative" x-data="{
    ...
    <button class="flex items-center text-gray-700" @click.prevent="toggleDropdown()" type="button">
        <span
            class="mr-3 overflow-hidden bg-brand-100 inline-flex items-center justify-center font-semibold rounded-full h-11 w-11">
            {{ Auth::user()->name[0] }}
        </span>
    ...
    <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-100"
        ...
        <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200">
            @php
                $menuItems = [
                    [
                        'text' => __('messages.Event Saya'),
                        'icon' => '  <svg xmlns="http://w3.org/2000/svg"
                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z" />
            </svg>',
                        'path' => route('mahasiswa.events'),
                    ],
                    [
                        'text' => 'Edit profile',
